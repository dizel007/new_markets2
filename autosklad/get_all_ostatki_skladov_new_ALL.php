...
$uploadfile = $uploaddir . basename( $_FILES['file_excel']['name']);
    ...
    else  // Если пришли в это условие, значит пробуем взять данные с JSON файла с остатками
         {
...
// ***********************************************************************************************************
/// Если разобрали товары, но все равно пытаемся обновить данные об остатках   
// ***********************************************************************************************************

    if(!file_exists('uploads/priznak_razbora_net.txt')) {
        echo "<h2 class=\"red_center\">После Обновления остатков были РАЗБОРЫ ТОВАРА, Нужно обновить данные со склада!!!</h2>";   
    }
