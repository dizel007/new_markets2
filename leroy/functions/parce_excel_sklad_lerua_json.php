...
function  Parce_excel_1c_sklad_for_lerua ($xls) {
...
$name_string = $j;
// ищем столбцы с нужными названиями (Где лежат остатки товаров)
...
for ($j=0; $j<30;$j++) {
 ...
 // Ищем строку с которой начинается список товароы
 $i=0;
   for ($str=0; $str<30;$str++) {
