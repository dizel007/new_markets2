...
// если НЕ нашли данных , то добавляем первые значения
		...
		$data_for_input['price_old'] = $item['price_now_WB'];
		$data_for_input['dis_price_old'] = $item['dis_price_now_WB'];
		$data_for_input['discount_old'] = $item['discount_now_WB'];
		$data_for_input['date_old'] = date('Y-m-d');
		$data_for_input['price_now'] = $item['price_now_WB'];
		$data_for_input['dis_price_now'] = $item['dis_price_now_WB'];
		$data_for_input['discount_now'] = $item['discount_now_WB'];
