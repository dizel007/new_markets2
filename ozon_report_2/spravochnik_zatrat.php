...
$arr_type_find_servives['Продвижение и реклама'] =  array(
    'Ускоренный сбор отзывов' => 'Ускоренный сбор отзывов',
    ...
    'Подписка Premium Pro' => 'Подписка Premium Pro',
    'Подписка Premium Pro (процент)' => 'Подписка Premium Pro (процент)',
...
$arr_type_find_servives['Услуги ФБО'] = array(
    ...
    'Обработка товара в составе грузоместа на FBO' => 'Обработка товара в составе грузоместа на FBO',
...
$arr_type_find_servives['Другие услуги и штрафы']  = array(
    ...
    'Жалобы покупателей: привезли не тот товар' => 'Жалобы покупателей: привезли не тот товар',
    'Жалобы покупателей: неполная комплектация' => 'Жалобы покупателей: неполная комплектация',
    'Жалобы покупателей: привезли не тот товар - отмена начисления' => 'Жалобы покупателей: привезли не тот товар - отмена начисления',
    'Отгрузка в нерекомендованный слот' => 'Отгрузка в нерекомендованный слот',

    'Отгрузка в нерекомендованный слот - отмена начисления' => 'Отгрузка в нерекомендованный слот - отмена начисления',
...
function raspredelenie_servicnih_rashodov_ozon_report(&$arr_for_sum_table, &$array_with_data,  $arr_type_find_servives)
{
    ...
    foreach ($array_with_data as $service => $service_summa) {
        ...
        if (($service == 'summa ') and ($nashli_tratu == 0)) {
            echo "$service = $service_summa<br>";
        }
    }
